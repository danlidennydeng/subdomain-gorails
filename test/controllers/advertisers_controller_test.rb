...
class AdvertisersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create advertiser" do
    assert_difference('Advertiser.count') do
      post advertisers_url, params: { advertiser: { email: @advertiser.email, subdomain: @advertiser.subdomain } }
    end
  ...
  test "should update advertiser" do
    patch advertiser_url(@advertiser), params: { advertiser: { email: @advertiser.email, subdomain: @advertiser.subdomain } }
